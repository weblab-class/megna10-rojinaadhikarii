  ...
  if (userId === null) {
    return (
      <div className="discover-container soft-bg discover-login-layout" style={{ alignItems: "center", paddingTop: "22vh", textAlign: "center", position: "relative" }}>
        ...
        <p style={{ fontFamily: "Josefin Sans", fontSize: "1.2rem", marginTop: "10px", color: "#888", minHeight: "1.5em", position: "relative", zIndex: 2 }}>
  ...
  return (
    <div className="discover-container">
      <div className="discover-content-wrapper">
        ...
        {viewMode === "map" ? (
          <MapDropdown spots={filteredSpots} isOpen={true} isPicking={true} tempCoords={tempCoords} onLocationSelect={handleMapClick} />
        ) : (
