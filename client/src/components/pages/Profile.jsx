...
const Profile = (props) => {
  ...
  const user = {
    name: props.user ? props.user.name : "First Name Last Name",
    email: props.user ? props.user.email : "email address",
    reviews: 0,
    followers: 0,
    following: 0
  };
      ...
      <div className="profile-content-wrapper">
        ...
        <div className="profile-tabs">
          <button className={`tab-btn ${activeTab === "bookmarks" ? "active" : ""}`} onClick={() => setActiveTab("bookmarks")}>
            <svg className="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>
            Bookmarked Spots
          </button>
          <div className="tab-divider"></div>
          <button className={`tab-btn ${activeTab === "favorites" ? "active" : ""}`} onClick={() => setActiveTab("favorites")}>
            <svg className="tab-icon heart-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
            My Favorites
          </button>
        </div>
        ...
        <div className="profile-spots-list">
          {activeTab === "bookmarks" ? (
             <div className="spot-card">
               <div className="spot-image"><img src="/jaho.jpg" alt="Jaho Coffee" /></div>
               <div className="spot-details">
                 <h3>Jaho Coffee Roaster & Wine Bar</h3>
                 <p className="spot-desc">Cozy coffee hangout pairing espresso drinks & lots of teas with light bites, baked goods & desserts</p>
                 <div className="spot-tags">
                   <span className="tag">WiFi</span> <span className="tag">Group Study</span> <span className="tag">Outlets</span>
                 </div>
               </div>
             </div>
          ) : (
